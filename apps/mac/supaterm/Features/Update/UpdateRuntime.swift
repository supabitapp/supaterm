...
final class UpdateRuntime: NSObject, @unchecked Sendable {
  ...
  init(license: UpdateLicenseClient) {
    #if DEBUG
      userDriver = UpdateDriver(hostBundle: Bundle.main, license: license)
      updater = nil
      super.init()
    #else
      let hostBundle = Bundle.main
      let userDriver = UpdateDriver(hostBundle: hostBundle, license: license)
  ...
  func retryUpdateCheck(_ updateCheck: SPUUpdateCheck) {
