...
public struct SocketRequestExecutor: Sendable {
  public enum AppRequest: Sendable {
    ...
    case agentHookCandidates(SupatermAgentHookCandidateQuery)
  ...
  public enum AppResult: Sendable {
    ...
    case agentHookCandidates(SupatermAgentHookCandidatesResponse)
  ...
  public enum TerminalPaneRequest: Sendable {
    ...
    case movePaneToNewTab(TerminalPaneTarget)
  ...
  public enum TerminalPaneResult: Sendable {
    ...
    case movePaneToNewTab(SupatermNewTabResult)
