...
struct TerminalHostStateTitleTests {
  ...
  @Test
  func resolvedSidebarDisplayTitleKeepsNonSpinnerTitle() {
    let title = TerminalHostState.resolvedSidebarDisplayTitle(
      title: "repo | thread",
      pwd: "/tmp/project",
      defaultValue: "Pane 1"
    )

    #expect(title == "repo | thread")
  }

  @Test
  func resolvedSidebarDisplayTitleStripsLeadingSpinnerToken() {
    let title = TerminalHostState.resolvedSidebarDisplayTitle(
      title: "⠋ repo",
      pwd: "/tmp/project",
      defaultValue: "Pane 1"
  ...
  @Test
  func resolvedSidebarDisplayTitleStripsMiddleSpinnerToken() {
    let title = TerminalHostState.resolvedSidebarDisplayTitle(
      title: "repo ⠋ Working | thread",
      pwd: "/tmp/project",
      defaultValue: "Pane 1"
    )

    #expect(title == "repo Working | thread")
  }

  @Test
  func resolvedSidebarDisplayTitlePreservesEmbeddedBrailleCharacters() {
    let title = TerminalHostState.resolvedSidebarDisplayTitle(
      title: "repo⠋",
      pwd: "/tmp/project",
      defaultValue: "Pane 1"
  ...
  @Test
  func resolvedSidebarDisplayTitleFallsBackToWorkingDirectoryWhenSpinnerIsOnlyTitle() {
    let title = TerminalHostState.resolvedSidebarDisplayTitle(
      title: "⠋",
      pwd: "/tmp/project",
      defaultValue: "Pane 1"
  ...
  @Test
  func resolvedSidebarDisplayTitleFallsBackToDefaultWhenSpinnerIsOnlyTitleAndDirectoryMissing() {
    let title = TerminalHostState.resolvedSidebarDisplayTitle(
      title: "⠋",
      pwd: nil,
      defaultValue: "Pane 1"
  ...
  @Test
  func resolvedPaneDisplayTitleKeepsSpinnerTitleRaw() {
    let title = TerminalHostState.resolvedPaneDisplayTitle(
      title: "⠋ repo",
      pwd: "/tmp/project",
      defaultValue: "Pane 1"
