enum SupatermUITestIdentifier {
  enum Accessibility {
    ...
    static let sidebarProjectPrefix = "sidebar.project."
    static let sidebarProjectHeaderPrefix = "sidebar.project-header."
    static let sidebarProjectTabMarker = ".tab."
    static let sidebarUnassignedHeader = "sidebar.unassigned-header"
  ...
  enum MenuItemIdentifier: String {
    ...
    case newTabInProject = "app.supabit.supaterm.file.newTabInProject"
