        ...
        <div className="mx-auto flex h-[52px] w-full max-w-[1440px] items-center justify-between px-6 md:px-10">
          ...
          <div className="flex items-center gap-2">
            <CtaLink
              ...
              variant="outline"
              showIcon={false}
              className="h-5 rounded-full border-white/12 bg-white/4 px-2.5 text-[0.62rem] leading-none font-normal text-white/82 hover:border-white/18 hover:bg-white/8"
            >
              GitHub
            </CtaLink>
            <CtaLink
              ...
              icon="download"
              showIcon={false}
              className="h-5 rounded-full bg-[#f1ede4] px-2.5 text-[0.62rem] leading-none font-normal text-[#12100b] hover:bg-white"
            >
              Download
            </CtaLink>
          </div>
        ...
        <div className="mx-auto flex w-full max-w-[1440px] flex-col px-6 pb-14 pt-[84px] md:px-10 md:pb-18 md:pt-[92px]">
          <div className="grid flex-1 items-center gap-10 pt-6 md:pt-10 xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] xl:gap-10 xl:pt-12">
            ...
            <div className="relative">
              <div className="group relative overflow-hidden border border-white/8 shadow-[0_40px_140px_-44px_rgba(0,0,0,0.9),0_8px_30px_-10px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)]">
