...
class AffectedProjectsTests(unittest.TestCase):
  def test_project_paths(self) -> None:
    cases = {
      ...
      ".github/actions/setup-macos/action.yml": {"host", "ios", "mac"},
      ".github/scripts/resign_exported_app.sh": {"host", "mac"},
      ".github/workflows/ci.yml": {"host", "ios", "mac"},
      ".github/workflows/release-tip.yml": {"host", "mac"},
      ".github/workflows/release.yml": {"host", "mac"},
      ".github/workflows/warm-cache.yml": {"host", "mac"},
      "apps/Configurations/Versions.xcconfig": {"host", "ios", "mac"},
      "apps/mac/supaterm/App.swift": {"mac"},
      "apps/mac/Makefile": {"host", "mac"},
      "apps/mac/ThirdParty/ghostty": {"host", "mac"},
      "apps/mac/scripts/build-ghostty.sh": {"host", "mac"},
      "apps/mac/scripts/build-supaterm-host.sh": {"host", "mac"},
      "apps/mac/supaterm/Resources/AgentDetection/rules.json": {"mac"},
      "apps/supaterm-host/src/lib.rs": {"host", "mac"},
      "apps/ios/SupatermApp.swift": {"ios"},
      "apps/shared/Theme.swift": {"ios", "mac"},
      "Makefile": {"docs", "host", "ios", "mac", "web"},
