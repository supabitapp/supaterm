...
- `apps/mac/Resources/bin/claude`
- `apps/mac/sp/SPClaudeHookSettings.swift`
...
- `apps/mac/supaterm/Features/Socket/SocketControlFeature.swift`
- `apps/mac/supaterm/App/TerminalWindowRegistry.swift`
- `apps/mac/supaterm/Features/Terminal/TerminalHostState.swift`
