...
- The final `terminal.agent_hook` request uses the selected pane's context and live detected process identity: PID and process start time. It never binds the Codex app-server process ID.
