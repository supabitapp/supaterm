...
mac-build-supaterm-tui:
	@$(MAKE) -C "$(MAC_APP_DIR)" build-supaterm-tui

mac-run-supaterm-tui: mac-build-supaterm-tui  # Build and run the Supaterm prompt TUI.
	@exec "$(MAC_APP_DIR)/.build/supaterm-tui/bin/supaterm"
